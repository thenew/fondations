...
$attchments_options = array(
    'image_copyright' => array(
        'label'       => __( 'Image copyright' ),
        'input'       => 'text',
        'helps'       => __( 'If your image is protected by copyrights' ),
        'application' => 'image',
        'exclusions'  => array( 'audio', 'video' ),
        'required'    => true,
        'error_text'  => __( 'Copyright field required' )
    ),
    'image_author_desc' => array(
        'label'       => __( 'Image author description' ),
        'input'       => 'textarea',
        'application' => 'image',
        'exclusions'   => array( 'audio', 'video' ),
    ),
    'image_watermark' => array(
        'label'       => __( 'Image watermark' ),
        'input'       => 'checkbox',
        'application' => 'image',
        'exclusions'   => array( 'audio', 'video' )
    ),
    'image_stars' => array(
        'label'       => __( 'Image rating' ),
        'input'       => 'radio',
        'options' => array(
            '0' => 0,
            '1' => 1,
    ...
    'image_disposition' => array(
        'label'       => __( 'Image disposition' ),
        'input'       => 'select',
        'options' => array(
            'portrait' => __( 'portrtait' ),
